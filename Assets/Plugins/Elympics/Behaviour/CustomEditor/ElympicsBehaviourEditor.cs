...
namespace Elympics
{
	...
	internal partial class ElympicsBehaviourEditor : Editor
	{
		...
		void OnEnable()
		{
			...
			_predictableToPlayers = serializedObject.FindProperty(nameof(_behaviour.predictabilityMask));
			_visibleToPlayers = serializedObject.FindProperty(nameof(_behaviour.visibilityMask));
		...
		{
			_predictableToPlayers.intValue =
				Convert.ToInt32(EditorGUILayout.EnumFlagsField(new GUIContent(Label_PredictableFor, Label_PredictabilityTooltip), (ElympicsBehaviourPlayersMask) _predictableToPlayers.intValue));
		...
		{
			_visibleToPlayers.intValue =
				Convert.ToInt32(EditorGUILayout.EnumFlagsField(new GUIContent(Label_VisibleFor, Label_VisibilityTooltip), (ElympicsBehaviourPlayersMask) _visibleToPlayers.intValue));
